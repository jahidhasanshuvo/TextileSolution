...
@section('admin_content')
    <div class="col-md-6">
        <div class="card">
            ...
            @endif
            <form action="{{route('work_plans.update',['id'=>$work_plan->id,'oid'=>$work_plan->order_id])}}" method="post">
                <div class="card-body">
                ...
                <div class="border-top">
                    <div class="card-body">
                        ...
                        <br>
                        <a href="{{route('work_plans.index',['oid'=>$work_plan->order_id])}}" class="btn btn-block">Back to List</a>
                    </div>
                </div>
            </form>
        </div>

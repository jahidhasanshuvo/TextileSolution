...
@section('admin_content')
    <div class="col-md-6">
        <div class="card">
            ...
            @endif
            <form class="form-horizontal" action="{{route('working_items.update',['id'=>$working_item->id])}}" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 text-right control-label col-form-label" for="fileInput">Working Item
                            Name: </label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" name="name" value="{{$working_item->name}}" required>
                        </div>
                    </div>
                </div>
